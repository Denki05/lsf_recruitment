...
<div class="content-card p-3">
  <form class="form-row" method="GET">
    <div class="form-group col-md-3"><input name="q" class="form-control form-control-sm" placeholder="Cari nama / KTP / HP" value="{{ request('q') }}"></div>
  ...
  <div class="table-responsive"><table class="table table-sm table-hover">
    <tr><th>#</th><th>Tanggal</th><th>Nama</th><th>KTP</th><th>Posisi</th><th>Status</th><th>Aksi</th></tr>
