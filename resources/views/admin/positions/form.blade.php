...
<div class="row">
  <div class="col-md-7 mb-2"><div class="content-card p-2" style="height:100%">
    ...
    <div class="form-group mb-2"><label>Deskripsi Pekerjaan</label><textarea name="description" class="form-control form-control-sm" rows="3" placeholder="Tulis tugas & syarat dengan kata natural, cth: Mengoperasikan forklift untuk bongkar muat gudang. Pengalaman min. 2 tahun di logistik.">{{ old('description', $position->description) }}</textarea><small style="color:var(--muted)">Tampil di kartu loker + kata kuncinya dipakai screening otomatis.</small></div>
  ...
  <div class="col-md-5 mb-2"><div class="content-card p-2" style="height:100%;border-left:3px solid var(--brand)">
    <h6 class="font-weight-bold">2 · Syarat Tambahan</h6>
    <div class="form-group mb-2"><label>Requirement <small style="color:var(--muted)">(1 poin per baris)</small></label><textarea name="requirements" class="form-control form-control-sm" rows="5" placeholder="Min. pengalaman 2 tahun di logistik&#10;Wajib SIM B aktif&#10;Bersedia kerja shift">{{ old('requirements', $position->requirements) }}</textarea></div>
