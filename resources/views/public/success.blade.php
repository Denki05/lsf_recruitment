...
<div class="text-center py-4">
  ...
  <p class="text-muted">Terima kasih <strong>{{ $applicant->nama_lengkap }}</strong> telah melamar <strong>{{ $applicant->position->full_title }}</strong>.</p>
  <table class="table table-sm text-left">
    <tr><th width="40%">No HP</th><td>{{ $applicant->no_hp }}</td></tr>
